...
public class MockHttpServletResponse extends MockServletResponse implements HttpServletResponse {
     ...
     * containing the specified message, setting the content type to "text/html". The server will
     * preserve cookies and may clear or update any headers needed to serve the error page as a
     * valid response.
     *
     ...
     * this method sets the status code to {@link #SC_FOUND} 302 (Found).
     *
     ...
     * defined in the web application, then {@link #sendError} must be used instead.</p>
     *
     ...
     *
     * <p>This method considers only response headers set or added via {@link #setHeader},
     * {@link #addHeader}, {@link #setDateHeader}, {@link #addDateHeader}, {@link #setIntHeader}, or
     * {@link #addIntHeader}, respectively.</p>
     *
